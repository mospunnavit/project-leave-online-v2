...
export async function GET(req: Request)  {
    ...
    const getYear = searchParams.get("year" as string) || currentYear.toString();
    ...
    try {
        const [leave_types_total] = await db.query(
            ...
            lt.quotaperyear - SUM(CASE WHEN lt.lt_code = l.lt_code  AND l.status = 'approved' THEN l.usequotaleave ELSE 0 END) 
